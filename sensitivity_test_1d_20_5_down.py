...
if __name__ == '__main__':
    ...
    params_20 = {
        ...
        "mortgage_rate": 0.06,
        "loan_term_years": 30,
        "property_tax_rate": 0.0058+0.0072,
        "maintenance_rate": 0.01,
        "home_appreciation_rate": 0.03,
        "monthly_rent": 2300,
        "rent_increase_rate": 0.03,
    ...
    base_params_20 = params_20.copy()

    heatmap_data = scan_1D(scan_range, base_params, param_name)
    heatmap_data20 = scan_1D(scan_range, base_params_20, param_name)

    # Run analysis and plot
    plt.plot(scan_range, heatmap_data, marker='o', label='5% Down Payment')
    plt.plot(scan_range, heatmap_data20, marker='o', label='20% Down Payment')
